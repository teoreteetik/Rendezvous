ngApp.directive('wordCloud', ['$interpolate', function($interpolate) {
        return {
            restrict: 'EA',
            replace: true,
            transclude: true,
            ...
            compile: function(elem, attr) {
                ...
                return function(scope, elem, attr) {
                    ...
                    var convertWords = function() {
                        ...
                        words = words.map(function(e) { return {word: e.word, size: e.size, rawSize: parseFloat(e.size), obj: e.obj }; });
